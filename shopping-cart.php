...
<script>
    ...
    function checkquan(check)
    {
        ...
        else
        {
            ...
            window.parent.detail.location.href="confirm.php";
            return true;
...
<form name="cartform" method="post" action="shopping-cart.php?operation=delete">
    <table border="0" rules=none cellspacing=0 style="border-bottom:#b5b5b5 1px solid; width: 640px;">
        ...
        <tr>
            <th>
                <?php echo "<input type=\"checkbox\" class=\"itemDelete\" name=\"".$_SESSION['cart'][$i]['product_id']."\">"; ?>
            </th>
...
<table border="0" rules=none cellspacing=0 style="width: 640px;" >
    <tr style="height: 40px;">
        <td style="width: 20%; ">
            <input type="submit" name="clear" value="clear" class="button_grey" onclick="clearCart()">
        </td>
        <td style="width: 20%; ">
            <input type="submit" name="delete" value="delete" class="button_grey" onclick="deleteCart();">
        </td>
...
<?php
print "<form action=\"cartDetail.php\"  method=\"post\" target=\"shopping_cart\" >";
