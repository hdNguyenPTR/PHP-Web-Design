...
<head>
    ...
    <script type="text/javascript">
        ...
        function addhover(obj){
            $("#purchase").css('background-color','#d94200');
        }
        function removehover(obj){
            $("#purchase").css('background-color','#e35e00')
        }
    </script>
</head>
<title>Title</title>
...
<header style="font-size: 22px; color: #797979; margin: 10px 0 10px 0;">CheckOut</header>
<div>
    <P style="font-size: 14px; color: #4d4d4d;">Please enter your delivery details below.</P>
    <P>
    <p style="color: #ff002b; display: inline">* </p>
    Indicates required fields
    </P>
</div>
<form name="checkOut" action="email.php" method="post">
    <table align="center" cellpadding="0" id="checkout_table" style="text-align: right">
        ...
        <tr>
            <td>
                <p style="color: red;display: inline";>*</p>Address
            </td>
            <th>
        ...
        <tr>
            <td>
                <p style="color: red;display: inline";>*</p>Suburb
            </td>
            <th>
                <input type="text" name="suburb" size="45"/>
            </th>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <p style="color: red;display: inline";>*</p>Country
            </td>
            <th>
                <select name="country">
...
<table>
    <tr>
        <input type="submit" value="Purchase" class="button_checkout" id="purchase" onclick="validate();" onmouseout="removehover(this)" onmouseover="addhover(this)"/>
    </tr>
</table>
</body>
</html>
